...
class EnemyDodge(pygame.sprite.Sprite):
    def __init__(self, bounds, scale):
        ...
        self.sourceImage = pygame.transform.scale(pygame.image.load("png/enemyUFO.png"), (scale, scale))
    ...
    def move(self, x):
        ...
        self.speed[0] += ACCELERATION * 1 if action % 2 == 0 else -1
        self.speed[1] += ACCELERATION * 1 if (action / 2) == 0 else 0.5
